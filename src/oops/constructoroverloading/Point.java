...
public class Point {
    ...
    public double distance(){
       ...
       // return calculateDistance(new Point(0,0),new Point(this.getX(), this.getY()));

        //Refactoring based on the Udemy requirement.
    ...
    public double distance(int x, int y){
        ...
        //Refactoring based on the Udemy requirement.
        //return calculateDistance(new Point(x,y), new Point(this.getX(),this.getY()));
    ...
    public double distance(Point point){
        ...
        //return calculateDistance(point, new Point(this.getX(), this.getY()));

        //Refactoring based on the Udemy requirement.
        return Math.sqrt((this.getX()-point.x)*(this.getX()-point.x)+(this.getY()-point.y)*(this.getY()-point.y));
    }


    // My utility function that calculates the distance

//    public double calculateDistance(Point A, Point B){  // Commenting this method to be in complaince with Udemy code.
